...
### Data
- The processed single cell RNA sequencing data and clonotype information have been deposited in the NCBI GEO database (**GSE232240**). Count and meta data are equal to the combined seurat objects in the preprocessing step of 1.separate_objects.R.
